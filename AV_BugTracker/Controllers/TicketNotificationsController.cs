...
namespace AV_BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,Message,Created,IsRead")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,Message,Created,IsRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
